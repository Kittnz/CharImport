...
Public Class Starter
    ...
    Private Sub Starter_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        My.Settings.writelog = True ' ###### Change it to false at pre-release ######
        ...
        runfunction.writelog("System: " & My.Computer.Info.OSFullName & " // " & My.Computer.Info.OSVersion & " // " & My.Computer.Info.OSPlatform, False)
        ...
        If Not My.Computer.FileSystem.FileExists(Application.StartupPath & "\mysql.data.dll") Then
            MsgBox("mysql.data.dll is missing. Please make sure to extract the whole archive!", MsgBoxStyle.Critical, "Warning")
            Application.Exit()
        End If
        Try
