...
Public Class Core_Check_Mangos
    ...
    Public Sub begincheck(ByVal startcond As Integer)
        ...
        If Main.xpac >= 3 Then
            check_character_talent() 'Wo ist die Talent Tabelle / Wo werden Talente gespeichert? (Mangos 2.4.3)
        Else
    ...
    Private Sub check_item_instance()
        tmpstring = ""
        If columnexist("guid", "item_instance") = False Then tmpstring = tmpstring & "// Column guid in item_instance does not exist!" & vbNewLine
        If columnexist("owner_guid", "item_instance") = False Then tmpstring = tmpstring & "// Column owner_guid in item_instance does not exist!" & vbNewLine
        If columnexist("data", "item_instance") = False Then tmpstring = tmpstring & "// Column data in item_instance does not exist!" & vbNewLine
    ...
    Private Sub check_character_spell()
        tmpstring = ""
        If columnexist("guid", "character_spell") = False Then tmpstring = tmpstring & "// Column guid in character_spell does not exist!" & vbNewLine
        If columnexist("spell", "character_spell") = False Then tmpstring = tmpstring & "// Column spell in character_spell does not exist!" & vbNewLine
        If columnexist("active", "character_spell") = False Then tmpstring = tmpstring & "// Column active in character_spell does not exist!" & vbNewLine
        If columnexist("disabled", "character_spell") = False Then tmpstring = tmpstring & "// Column disabled in character_spell does not exist!" & vbNewLine
        If Not tmpstring = "" Then gettableschema("character_spell")
        errorstring = errorstring & tmpstring
    End Sub
    Private Sub check_character_skills()
        tmpstring = ""
        If columnexist("guid", "character_skills") = False Then tmpstring = tmpstring & "// Column guid in character_skills does not exist!" & vbNewLine
        If columnexist("skill", "character_skills") = False Then tmpstring = tmpstring & "// Column skill in character_skills does not exist!" & vbNewLine
        If columnexist("value", "character_skills") = False Then tmpstring = tmpstring & "// Column value in character_skills does not exist!" & vbNewLine
        If columnexist("max", "character_skills") = False Then tmpstring = tmpstring & "// Column max in character_skills does not exist!" & vbNewLine
    ...
    Private Sub check_character_queststatus()
        tmpstring = ""
        If columnexist("guid", "character_queststatus") = False Then tmpstring = tmpstring & "// Column guid in character_queststatus does not exist!" & vbNewLine
        If columnexist("quest", "character_queststatus") = False Then tmpstring = tmpstring & "// Column quest in character_queststatus does not exist!" & vbNewLine
        If columnexist("status", "character_queststatus") = False Then tmpstring = tmpstring & "// Column status in character_queststatus does not exist!" & vbNewLine
        If columnexist("explored", "character_queststatus") = False Then tmpstring = tmpstring & "// Column explored in character_queststatus does not exist!" & vbNewLine
        If columnexist("timer", "character_queststatus") = False Then tmpstring = tmpstring & "// Column timer in character_queststatus does not exist!" & vbNewLine
