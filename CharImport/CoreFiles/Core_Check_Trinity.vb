...
Public Class Core_Check_Trinity
    ...
    Private Sub check_item_instance()
        tmpstring = ""
        If columnexist("itemEntry", "item_instance") = False Then tmpstring = tmpstring & "// Column itemEntry in item_instance does not exist!" & vbNewLine
        ...
        If columnexist("enchantments", "item_instance") = False Then tmpstring = tmpstring & "// Column enchantments in item_instance does not exist!" & vbNewLine
        If Not tmpstring = "" Then gettableschema("item_instance")
        errorstring = errorstring & tmpstring
    End Sub
    Private Sub check_character_talent()
        tmpstring = ""
        If columnexist("spell", "character_talent") = False Then tmpstring = tmpstring & "// Column spell in character_talent does not exist!" & vbNewLine
