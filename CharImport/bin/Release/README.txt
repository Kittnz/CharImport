...
• Tested with WoW TBC Patch 2.4.3, WotLK Patch 3.3.5, Cataclysm Patch 4.0.6
...
Update 0.10.3 (Test) @indev

 > Improved support for 4.x clients
...
Update 0.10.2 (Beta)
 ...
 > Support for 5.x Armory added
 > The application will no longer stuck when loading characters from the armory
 > The character gender will now get parsed from the armory
 > Fixed loading certain enchantments from armory 
 > Enchantment labels should now always be visible when active
 > Some minnor changes
